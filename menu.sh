...
SSL_CERT_DIR="/etc/ambervpn/ssl"
SSL_CERT_FILE="$SSL_CERT_DIR/ambervpn.pem"
SSL_CERT_CHAIN_FILE="$SSL_CERT_DIR/ambervpn.crt"
SSL_CERT_KEY_FILE="$SSL_CERT_DIR/ambervpn.key"
...
LOGIN_INFO_SCRIPT="/usr/local/bin/ambervpn-login-info.sh"
SSHD_FF_CONFIG="/etc/ssh/sshd_config.d/ambervpn.conf"
